...
### New
- Dictionary (Pro): personal terms and jargon, first in the Pro catalog. Free is locked with an in-app Plans upsell. Settings → Engine and menu bar → Dictionary…. Pro can add, edit, and delete local terms. Mabel feeds them into the existing whisper.cpp prompt hook and local Gemma spelling hints. Terms stay on this Mac — no cloud sync, no Nexus write, no team share.
