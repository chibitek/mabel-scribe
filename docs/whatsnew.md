...
- Snippets (Pro surface): personal trigger → expansion, second in the Pro catalog (after Dictionary). Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. Settings → Engine and menu bar → Snippets…. Signed-in Pro can add and remove local shortcuts. Mabel expands spoken triggers during dictation on this Mac — not Dictionary spellings, not Polish, not Clipboard History. No cloud sync, no Nexus write, no team share.
