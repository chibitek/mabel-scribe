...
// (publicHeadersPath + Swift) is a common `swift build` failure on
// Xcode 16. The C header stays in Sources/.../include for humans and
// matching the Rust FFI; it is not part of this product.
//
