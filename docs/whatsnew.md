...
### New
- Polish (Pro): Off, Casual, Professional, or Polite. Default Off. Free cannot enable it. After a transcript, local Gemma tidies what you said and never invents — bad model output falls back to the rules pass. Settings → Engine and the menu-bar Polish submenu. Upgrade stays in Settings → Plans (no website).
