...
### New
- Dictionary (Pro surface): personal terms and jargon, first in the Pro catalog. Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. Settings → Engine and menu bar → Dictionary…. Signed-in Pro can add, edit, and delete local terms. Mabel feeds them into the existing whisper.cpp prompt hook and local Gemma spelling hints. Terms stay on this Mac — no cloud sync, no Nexus write, no team share.
- Snippets (Pro surface): personal trigger → expansion, second in the Pro catalog (after Dictionary). Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. Settings → Engine, sidebar, and menu bar → Snippets…. Signed-in Pro can add, edit, and delete local shortcuts. Mabel expands spoken triggers during cleanup / dictation paste on this Mac — not Dictionary spellings, not Polish, not Clipboard History. No cloud sync, no Nexus write, no team share.
- Style (Pro surface): Formal, Casual, or Very casual register, third in the Pro catalog (after Dictionary and Snippets). Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. Default is unset until you pick. Settings → Engine, sidebar, and menu bar → Style…. Signed-in Pro can pick or clear the register. Mabel applies it locally during cleanup / dictation paste on this Mac — not Polish tone rewrite, not Dictionary spellings, not Snippets. No freeform casing prefs. No cloud sync, no Nexus write, no team share.
- Transforms (Pro surface): Email, Bullet points, Make shorter, or Make clearer, fourth in the Pro catalog (after Dictionary, Snippets, and Style). Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. User-invoked only — never auto-on. Settings → Engine, sidebar, and menu bar → Transforms…. Signed-in Pro pastes dictated or selected text and invokes a rewrite. Local Gemma; never invents facts; stays on this Mac — not Style register, not Polish tone, not Dictionary, not Snippets, not Clipboard. No cloud sync, no Nexus write, no team share.
- Scratchpad (Pro surface): local-only dictations and notes, fifth in the Pro catalog (after Dictionary, Snippets, Style, and Transforms). Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. Settings → Engine, sidebar, and menu bar → Scratchpad…. Signed-in Pro can dump, edit, and clear notes on this Mac — not Style, not Transforms, not Polish, not Dictionary, not Snippets, not Clipboard. Not an MCP source or sink. No cloud sync, no Nexus/Mochii promote, no team share.
- Insights (Pro surface): local-only dictation counts, streaks, and time saved, sixth and last in the Pro catalog (after Dictionary, Snippets, Style, Transforms, and Scratchpad). Requires App Store Pro and a Stiki session. Free is locked with Activate Pro / Sign in with Stiki. Settings → Engine, sidebar, and menu bar → Insights…. Signed-in Pro sees usage on this Mac — never the words. Not Scratchpad, not Dictionary, not Snippets, not Style, not Transforms, not Polish, not Clipboard. Not an MCP source or sink. No cloud sync, no team/company dashboards, no third-party analytics vendor, no Nexus/SIEM write. Free dictation still works without an account and still records local counts. Sign-out locks Insights.
- Connectors (Pro): Sign in with Stiki in Settings → Account (Apple, Google, or Microsoft at auth.chibitek.com — same as Get Mochii). Pro surfaces need that session plus StoreKit. Free dictation works without an account. A Get Mochii session is identity only — SSO is never connected. Each door stays shut until you connect it (explicit Connect + ACL). Sign-out drops both doors. Stiki KYC and Suite ACL fail closed. Scratchpad stays on this Mac in v1 — not an MCP source or sink. No cookie auto-reconnect. Cat UI. No website upgrade.
...
- Pro unlocks dictionary, teams (organization, seats, local invites), snippets, style, transforms, scratchpad, insights, and Connectors. Free stays personal-only.
